...
<div class="service-details-area pt-100 pb-70">
    ...
    <div class="container">
        ...
        <div class="col-lg-6 col-md-6">
            <div class="form-group"><input type="text" name="address" class="form-control" value="{{ $profileData->address }}">
        ...
        <div class="col-lg-6 col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="address" class="form-control" value="{{ $profileData->address }}">            </div>
        </div>
